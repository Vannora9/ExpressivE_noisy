...
# test="true"
# seeds="1,2,3"
# config="Best_Configurations/ExpressivE/Base_ExpressivE/WN18RR.json"
# expName="Base_ExpressivE_WN18RR"
...
train_path = '/home_lab_local/s2010417/PHD/ExpressivE_noisy/ExpressivE/Noisy_data/FB15K_Noisy/fb15k_train_20noisy.txt'
test_path = '/home_lab_local/s2010417/PHD/ExpressivE_noisy/ExpressivE/Noisy_data/FB15K_Noisy/test.txt'
    ...
    if train:
        for seed in seeds:
            ...
            pipeline(
                ...
                # stopper=config['stopper'],stopper=config['stopper'],
...
sys.argv.append("train=true")
sys.argv.append("test=true")
sys.argv.append("seeds=1,2,3")
sys.argv.append("config=Best_Configurations/ExpressivE/Base_ExpressivE/FB15k-237.json")
sys.argv.append("expName=Base_ExpressivE_FB15K-237_20noisy")
